...
#Region " Windows Form Designer generated code "
    ...
    "(such as TclIMAP4 or MS Outlook client to connect to this server."
        ...
        'CertificateStore1
        '
        Me.CertificateStore1.ValidFrom = New Date(2009, 8, 18, 12, 46, 41, 109)
        Me.CertificateStore1.ValidTo = New Date(2010, 8, 18, 12, 46, 41, 109)
        '
        'Imap4Server1
        '
...
#End Region
    ...
    Private Sub btnStart_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnStart.Click
        Try
            Select Case cbUseTls.SelectedIndex
                Case 0
                    Imap4Server1.UseTls = ServerTlsMode.None
                Case 1
                    Imap4Server1.UseTls = ServerTlsMode.Implicit
                Case 2
                    Imap4Server1.UseTls = ServerTlsMode.ExplicitAllow
                Case 3
                    Imap4Server1.UseTls = ServerTlsMode.ExplicitRequire
            End Select
    ...
    Private Sub Imap4Server1_GetCertificate(ByVal sender As System.Object, ByVal e As CleverComponents.InetSuite.GetCertificateEventArgs) Handles Imap4Server1.GetCertificate
